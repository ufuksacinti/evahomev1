    ...
    public function run(): void
    {
        $collections = [
            [
                'name' => 'Golden Jasmine',
                'slug' => 'golden-jasmine',
                'description' => 'Işıltılı ve sıcak bir atmosfer yaratan, pastel ekru tonlarında zarif bir koleksiyon.',
                'type' => 'energy',
                'color_hex' => '#F6EBD9',
            ...
            [
                'name' => 'Velvet Rose',
                'slug' => 'velvet-rose',
                'description' => 'Romantik ve zarif, kadife dokunuşlu güllerin yumuşak pembe tonlarında bir koleksiyon.',
                'type' => 'energy',
                'color_hex' => '#D9A7A0',
            ...
            [
                'name' => 'Citrus Harmony',
                'slug' => 'citrus-harmony',
                'description' => 'Neşeli ve enerjik, turunçgil kokularının canlılığını yansıtan bir koleksiyon.',
                'type' => 'energy',
                'color_hex' => '#F9CBA3',
            ...
            [
                'name' => 'Luminous Bloom',
                'slug' => 'luminous-bloom',
                'description' => 'Arınmış ve taze, pembe çiçeklerin zarif açılışını yansıtan bir koleksiyon.',
                'type' => 'energy',
                'color_hex' => '#F5CEDB',
            ...
            [
                'name' => 'Sacred Oud',
                'slug' => 'sacred-oud',
                'description' => 'Dingin ve mistik, kutsal ağacın derinliklerini yansıtan yeşil tonlarında bir koleksiyon.',
                'type' => 'energy',
                'color_hex' => '#C9D8C5',
            ...
            [
                'name' => 'Earth Harmony',
                'slug' => 'earth-harmony',
                'description' => 'Topraklanmış ve güvenli, doğanın sıcak bej tonlarında huzur veren bir koleksiyon.',
                'type' => 'energy',
                'color_hex' => '#D7C8B6',
            ...
            [
                'name' => 'Royal Spice',
                'slug' => 'royal-spice',
                'description' => 'Sofistike ve güçlü, baharatların asil tonlarında nötr bir koleksiyon.',
                'type' => 'energy',
                'color_hex' => '#C4BDB5',
            ...
            [
                'name' => 'Lavender Peace',
                'slug' => 'lavender-peace',
                'description' => 'Sakin ve huzurlu, lavanta tarlalarının yumuşak lila tonlarında dinginlik veren bir koleksiyon.',
                'type' => 'energy',
                'color_hex' => '#D4C3E1',
